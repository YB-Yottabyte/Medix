...
Run from project root:
    uv run python scripts/clean_medvidqa.py

Output:
    MedVidQA/cleaned/train.json
    MedVidQA/cleaned/val.json
    MedVidQA/cleaned/test.json
    MedVidQA/cleaned/cleaning_report.json
"""
...
DATA_DIR = PROJECT_ROOT / "MedVidQA"
...
def clean_entry(entry: dict) -> tuple[dict | None, list[str]]:
    """
...
def clean_split(split: str) -> dict:
    ...
    for i, entry in enumerate(raw):
        result, issues = clean_entry(entry)
