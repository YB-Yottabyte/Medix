...
class TranscriptFetcher:
    def __init__(self, cache_dir: str = "./data/transcript_cache"):
        ...
        try:
            ...
            print("Warning: youtube-transcript-api not installed. Transcripts unavailable.")

    def _cache_path(self, video_id: str) -> Path:
        return self.cache_dir / f"{video_id}.json"

    def fetch(self, video_id: str, start: float = None, end: float = None) -> Optional[str]:
        """
    ...
    def _filter_and_format(self, snippets: list, start: float = None, end: float = None) -> str:
    ...
    def _load_cache(self, video_id: str) -> Optional[list]:
    ...
    def _save_cache(self, video_id: str, snippets: list):
        try:
            ...
            print(f"Could not cache transcript for {video_id}: {e}")
